...
const DosingDevicesListCmp = ({dosingDevices, setSorting, title = "Dysze dozujeące"}) => {
    return <ContainerCmp title={title} loaded={dosingDevices}>
        <Table>
            <Thead>
                <Tr>
                    <Th onClick={()=>{setSorting("id")}}>Nr.:</Th>
                    <Th onClick={()=>{setSorting("lineName")}}>Linia:</Th>
                    <Th onClick={()=>{setSorting("moduleType")}}>Moduł:</Th>
                    <Th onClick={()=>{setSorting("totalMaterial")}}>Ilość parafiny:</Th>
                    <Th onClick={()=>{setSorting("correctMeasurePercent")}}>Poprawnych <br/> pomiarów:</Th>
                    <Th onClick={()=>{setSorting("averageMeasure")}}>Średnia <br/> waga:</Th>
                    <Th onClick={()=>{setSorting("amountBelowMeasures")}}>Pomiarów <br/> poniżej wagi:</Th>
                    <Th onClick={()=>{setSorting("amountCorrectMeasures")}}>Poprawnych <br/> pomiarów:</Th>
                    <Th onClick={()=>{setSorting("amountAboveMeasures")}}>Pomiarów <br/> powyżej wagi:</Th>
                </Tr>
            </Thead>
            <Tbody>
